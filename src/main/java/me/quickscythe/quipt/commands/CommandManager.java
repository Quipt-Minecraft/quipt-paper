...
public class CommandManager {
    public static void init() {
        ...
        new CommandExecutor.Builder(new EventCommand(CoreUtils.plugin())).setDescription("Default event command.").register();
        new CommandExecutor.Builder(new SudoCommand(CoreUtils.plugin())).setDescription("Sudo command").register();
    }

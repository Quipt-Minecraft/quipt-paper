...
public class Loader implements PluginLoader {
    ...
    public void classloader(PluginClasspathBuilder classpathBuilder) {
        ...
        File dependenciesFile = new File("dependencies-quipt-paper.json");
    ...
    public SimpleJsonObject defaultDependencies(File dependenciesFile) throws IOException {
        ...
        bot.put("artifact", "quipt-core");
        bot.put("version", "0.1.1-alpha-B1");

        SimpleJsonObject core = new SimpleJsonObject();
        core.put("group", "me.quickscythe");
        core.put("artifact", "quipt-paper");
        core.put("version", "1.1.8-alpha-B5");
